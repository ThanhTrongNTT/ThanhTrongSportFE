    ...
    return (
        <footer className="bg-gray-200" aria-labelledby="footer-heading">
            ...
            <div className="mx-auto max-w-7xl px-6 pb-4 pt-8 sm:pt-12 lg:px-8 lg:pt-16">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-0">
                        ...
                        <p className="text-sm leading-6 text-gray-600">
                            Enhancing your game with top-quality gear and
                            promoting respect in sports worldwide.
                        </p>
                ...
                <div className="mt-4 border-t border-gray-900/10 pt-4 sm:mt-8 lg:mt-12">
